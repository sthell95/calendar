...
type EventServiceClient interface {
	...
	Delete(ctx context.Context, in *EventId, opts ...grpc.CallOption) (*DeleteResponse, error)
}
...
func (c *eventServiceClient) Delete(ctx context.Context, in *EventId, opts ...grpc.CallOption) (*DeleteResponse, error) {
...
type EventServiceServer interface {
	...
	Delete(context.Context, *EventId) (*DeleteResponse, error)
...
func (UnimplementedEventServiceServer) Delete(context.Context, *EventId) (*DeleteResponse, error) {
